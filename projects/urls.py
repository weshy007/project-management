...
urlpatterns =[
    ...
    path('projects/<int:pk>', views.project_list, name ='project-detail'), 
    path('tasks', views.task_list, name ='tasks'),
    path('tasks/<int:pk>', views.task_detail, name ='task-detail'),
    path('create-task', views.task_create, name ='create-task'),
    ...
    path('join-task/<int:pk>', views.join_task, name ='join-task'), 
